...
candle_ros2__srv__GenericMd80Msg_Request__init(candle_ros2__srv__GenericMd80Msg_Request * msg)
{
  ...
  if (!rosidl_runtime_c__uint16__Sequence__init(&msg->drive_ids, 0)) {
    candle_ros2__srv__GenericMd80Msg_Request__fini(msg);
    return false;
  }
  return true;
}
...
candle_ros2__srv__GenericMd80Msg_Request__create(void)
{
  ...
  candle_ros2__srv__GenericMd80Msg_Request * msg = (candle_ros2__srv__GenericMd80Msg_Request *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(candle_ros2__srv__GenericMd80Msg_Request));
  bool success = candle_ros2__srv__GenericMd80Msg_Request__init(msg);
  if (!success) {
...
candle_ros2__srv__GenericMd80Msg_Request__Sequence__init(candle_ros2__srv__GenericMd80Msg_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Request * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Request)) {
      return false;
    }
    data = (candle_ros2__srv__GenericMd80Msg_Request *)allocator.zero_allocate(size, sizeof(candle_ros2__srv__GenericMd80Msg_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = candle_ros2__srv__GenericMd80Msg_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        candle_ros2__srv__GenericMd80Msg_Request__fini(&data[i - 1]);
      }
...
candle_ros2__srv__GenericMd80Msg_Request__Sequence__fini(candle_ros2__srv__GenericMd80Msg_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      candle_ros2__srv__GenericMd80Msg_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Request__Sequence * array = (candle_ros2__srv__GenericMd80Msg_Request__Sequence *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = candle_ros2__srv__GenericMd80Msg_Request__Sequence__init(array, size);
  if (!success) {
...
candle_ros2__srv__GenericMd80Msg_Request__Sequence__destroy(candle_ros2__srv__GenericMd80Msg_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    candle_ros2__srv__GenericMd80Msg_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
candle_ros2__srv__GenericMd80Msg_Request__Sequence__are_equal(const candle_ros2__srv__GenericMd80Msg_Request__Sequence * lhs, const candle_ros2__srv__GenericMd80Msg_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  candle_ros2__srv__GenericMd80Msg_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Request)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(candle_ros2__srv__GenericMd80Msg_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    candle_ros2__srv__GenericMd80Msg_Request * data =
      (candle_ros2__srv__GenericMd80Msg_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!candle_ros2__srv__GenericMd80Msg_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          candle_ros2__srv__GenericMd80Msg_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Request__copy(
...
candle_ros2__srv__GenericMd80Msg_Response__init(candle_ros2__srv__GenericMd80Msg_Response * msg)
{
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->drives_success, 0)) {
    candle_ros2__srv__GenericMd80Msg_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Response * msg = (candle_ros2__srv__GenericMd80Msg_Response *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(candle_ros2__srv__GenericMd80Msg_Response));
  bool success = candle_ros2__srv__GenericMd80Msg_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
candle_ros2__srv__GenericMd80Msg_Response__Sequence__init(candle_ros2__srv__GenericMd80Msg_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Response * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Response)) {
      return false;
    }
    data = (candle_ros2__srv__GenericMd80Msg_Response *)allocator.zero_allocate(size, sizeof(candle_ros2__srv__GenericMd80Msg_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = candle_ros2__srv__GenericMd80Msg_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        candle_ros2__srv__GenericMd80Msg_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
candle_ros2__srv__GenericMd80Msg_Response__Sequence__fini(candle_ros2__srv__GenericMd80Msg_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      candle_ros2__srv__GenericMd80Msg_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Response__Sequence * array = (candle_ros2__srv__GenericMd80Msg_Response__Sequence *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = candle_ros2__srv__GenericMd80Msg_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
candle_ros2__srv__GenericMd80Msg_Response__Sequence__destroy(candle_ros2__srv__GenericMd80Msg_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    candle_ros2__srv__GenericMd80Msg_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
candle_ros2__srv__GenericMd80Msg_Response__Sequence__are_equal(const candle_ros2__srv__GenericMd80Msg_Response__Sequence * lhs, const candle_ros2__srv__GenericMd80Msg_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  candle_ros2__srv__GenericMd80Msg_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Response)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(candle_ros2__srv__GenericMd80Msg_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    candle_ros2__srv__GenericMd80Msg_Response * data =
      (candle_ros2__srv__GenericMd80Msg_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!candle_ros2__srv__GenericMd80Msg_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          candle_ros2__srv__GenericMd80Msg_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
candle_ros2__srv__GenericMd80Msg_Event__init(candle_ros2__srv__GenericMd80Msg_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    candle_ros2__srv__GenericMd80Msg_Event__fini(msg);
    return false;
  }
  // request
  if (!candle_ros2__srv__GenericMd80Msg_Request__Sequence__init(&msg->request, 0)) {
    candle_ros2__srv__GenericMd80Msg_Event__fini(msg);
    return false;
  }
  // response
  if (!candle_ros2__srv__GenericMd80Msg_Response__Sequence__init(&msg->response, 0)) {
    candle_ros2__srv__GenericMd80Msg_Event__fini(msg);
    return false;
  }
  return true;
...
candle_ros2__srv__GenericMd80Msg_Event__fini(candle_ros2__srv__GenericMd80Msg_Event * msg)
{
  ...
  // request
  candle_ros2__srv__GenericMd80Msg_Request__Sequence__fini(&msg->request);
  // response
  candle_ros2__srv__GenericMd80Msg_Response__Sequence__fini(&msg->response);
}
...
candle_ros2__srv__GenericMd80Msg_Event__are_equal(const candle_ros2__srv__GenericMd80Msg_Event * lhs, const candle_ros2__srv__GenericMd80Msg_Event * rhs)
{
  ...
  // request
  if (!candle_ros2__srv__GenericMd80Msg_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!candle_ros2__srv__GenericMd80Msg_Response__Sequence__are_equal(
  ...
  candle_ros2__srv__GenericMd80Msg_Event * output)
{
  ...
  // request
  if (!candle_ros2__srv__GenericMd80Msg_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!candle_ros2__srv__GenericMd80Msg_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Event * msg = (candle_ros2__srv__GenericMd80Msg_Event *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(candle_ros2__srv__GenericMd80Msg_Event));
  bool success = candle_ros2__srv__GenericMd80Msg_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
candle_ros2__srv__GenericMd80Msg_Event__Sequence__init(candle_ros2__srv__GenericMd80Msg_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Event)) {
      return false;
    }
    data = (candle_ros2__srv__GenericMd80Msg_Event *)allocator.zero_allocate(size, sizeof(candle_ros2__srv__GenericMd80Msg_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = candle_ros2__srv__GenericMd80Msg_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        candle_ros2__srv__GenericMd80Msg_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
candle_ros2__srv__GenericMd80Msg_Event__Sequence__fini(candle_ros2__srv__GenericMd80Msg_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      candle_ros2__srv__GenericMd80Msg_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  candle_ros2__srv__GenericMd80Msg_Event__Sequence * array = (candle_ros2__srv__GenericMd80Msg_Event__Sequence *)allocator.allocate(sizeof(candle_ros2__srv__GenericMd80Msg_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = candle_ros2__srv__GenericMd80Msg_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
candle_ros2__srv__GenericMd80Msg_Event__Sequence__destroy(candle_ros2__srv__GenericMd80Msg_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    candle_ros2__srv__GenericMd80Msg_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
candle_ros2__srv__GenericMd80Msg_Event__Sequence__are_equal(const candle_ros2__srv__GenericMd80Msg_Event__Sequence * lhs, const candle_ros2__srv__GenericMd80Msg_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  candle_ros2__srv__GenericMd80Msg_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(candle_ros2__srv__GenericMd80Msg_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(candle_ros2__srv__GenericMd80Msg_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    candle_ros2__srv__GenericMd80Msg_Event * data =
      (candle_ros2__srv__GenericMd80Msg_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!candle_ros2__srv__GenericMd80Msg_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          candle_ros2__srv__GenericMd80Msg_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!candle_ros2__srv__GenericMd80Msg_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
