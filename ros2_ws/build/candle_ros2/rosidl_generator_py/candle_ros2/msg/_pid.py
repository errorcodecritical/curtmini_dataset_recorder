...
class Pid(metaclass=Metaclass_Pid):
    ...
    def __init__(self, **kwargs):
        ...
        self.i_windup = kwargs.get('i_windup', float())
        self.max_output = kwargs.get('max_output', float())
    ...
    def __eq__(self, other):
        ...
        if self.kd != other.kd:
            return False
        if self.i_windup != other.i_windup:
            return False
    ...
    @builtins.property
    def i_windup(self):
        """Message field 'i_windup'."""
        return self._i_windup

    @i_windup.setter
    def i_windup(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'i_windup' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'i_windup' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._i_windup = value
    ...
    def max_output(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'max_output' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_output' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
