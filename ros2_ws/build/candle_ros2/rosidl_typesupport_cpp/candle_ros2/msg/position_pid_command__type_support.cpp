...
static const _PositionPidCommand_type_support_symbol_names_t _PositionPidCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, candle_ros2, msg, PositionPidCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, candle_ros2, msg, PositionPidCommand)),
  }
};
...
{
  return &::candle_ros2::msg::rosidl_typesupport_cpp::PositionPidCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, candle_ros2, msg, PositionPidCommand)() {
  return get_message_type_support_handle<candle_ros2::msg::PositionPidCommand>();
}
