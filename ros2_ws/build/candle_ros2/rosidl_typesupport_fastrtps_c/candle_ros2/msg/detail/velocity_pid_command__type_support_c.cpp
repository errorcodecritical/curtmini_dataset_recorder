...
#include "candle_ros2/msg/detail/velocity_pid_command__rosidl_typesupport_fastrtps_c.h"
...
#include "candle_ros2/msg/detail/pid__functions.h"  // velocity_pid
...
using _VelocityPidCommand__ros_msg_type = candle_ros2__msg__VelocityPidCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
bool cdr_serialize_candle_ros2__msg__VelocityPidCommand(
  const candle_ros2__msg__VelocityPidCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
bool cdr_deserialize_candle_ros2__msg__VelocityPidCommand(
  eprosima::fastcdr::Cdr & cdr,
  candle_ros2__msg__VelocityPidCommand * ros_message)
{
  // Field name: drive_ids
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
size_t get_serialized_size_candle_ros2__msg__VelocityPidCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityPidCommand__ros_msg_type * ros_message = static_cast<const _VelocityPidCommand__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
size_t max_serialized_size_candle_ros2__msg__VelocityPidCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = candle_ros2__msg__VelocityPidCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
bool cdr_serialize_key_candle_ros2__msg__VelocityPidCommand(
  const candle_ros2__msg__VelocityPidCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: drive_ids
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
size_t get_serialized_size_key_candle_ros2__msg__VelocityPidCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityPidCommand__ros_msg_type * ros_message = static_cast<const _VelocityPidCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_candle_ros2
size_t max_serialized_size_key_candle_ros2__msg__VelocityPidCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static bool _VelocityPidCommand__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const candle_ros2__msg__VelocityPidCommand * ros_message = static_cast<const candle_ros2__msg__VelocityPidCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_candle_ros2__msg__VelocityPidCommand(ros_message, cdr);
}

static bool _VelocityPidCommand__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  candle_ros2__msg__VelocityPidCommand * ros_message = static_cast<candle_ros2__msg__VelocityPidCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_candle_ros2__msg__VelocityPidCommand(cdr, ros_message);
}

static uint32_t _VelocityPidCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_candle_ros2__msg__VelocityPidCommand(
      untyped_ros_message, 0));
}

static size_t _VelocityPidCommand__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_candle_ros2__msg__VelocityPidCommand(
...
static message_type_support_callbacks_t __callbacks_VelocityPidCommand = {
  "candle_ros2::msg",
  "VelocityPidCommand",
  _VelocityPidCommand__cdr_serialize,
  _VelocityPidCommand__cdr_deserialize,
  _VelocityPidCommand__get_serialized_size,
  _VelocityPidCommand__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _VelocityPidCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VelocityPidCommand,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, candle_ros2, msg, VelocityPidCommand)() {
  return &_VelocityPidCommand__type_support;
}
