...
#include "candle_ros2/msg/detail/motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const candle_ros2::msg::MotionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  candle_ros2::msg::MotionCommand & ros_message)
{
  // Member: drive_ids
  {
    cdr >> ros_message.drive_ids;
  ...
  size_t current_alignment)
{
  ...
  // Member: target_velocity
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.target_velocity[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: target_torque
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.target_torque[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = candle_ros2::msg::MotionCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const candle_ros2::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<candle_ros2::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  return &candle_ros2::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, candle_ros2, msg, MotionCommand)() {
  return &candle_ros2::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
