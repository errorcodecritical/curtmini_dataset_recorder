...
#include "candle_ros2/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = candle_ros2::msg::Pid;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const candle_ros2::msg::Pid *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<candle_ros2::msg::Pid *>(
    untyped_ros_message);
...
{
  return &candle_ros2::msg::typesupport_fastrtps_cpp::_Pid__handle;
}
