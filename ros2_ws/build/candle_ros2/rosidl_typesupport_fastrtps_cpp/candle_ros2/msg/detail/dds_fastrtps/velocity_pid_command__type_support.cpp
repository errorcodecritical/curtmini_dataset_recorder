...
#include "candle_ros2/msg/detail/velocity_pid_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const candle_ros2::msg::VelocityPidCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  candle_ros2::msg::VelocityPidCommand & ros_message)
{
  // Member: drive_ids
  {
    cdr >> ros_message.drive_ids;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_candle_ros2
max_serialized_size_VelocityPidCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = candle_ros2::msg::VelocityPidCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_candle_ros2
max_serialized_size_key_VelocityPidCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const candle_ros2::msg::VelocityPidCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<candle_ros2::msg::VelocityPidCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VelocityPidCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const candle_ros2::msg::VelocityPidCommand *>(
...
static size_t _VelocityPidCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VelocityPidCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VelocityPidCommand__callbacks = {
  "candle_ros2::msg",
  "VelocityPidCommand",
...
static rosidl_message_type_support_t _VelocityPidCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VelocityPidCommand__callbacks,
...
{
  return &candle_ros2::msg::typesupport_fastrtps_cpp::_VelocityPidCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, candle_ros2, msg, VelocityPidCommand)() {
  return &candle_ros2::msg::typesupport_fastrtps_cpp::_VelocityPidCommand__handle;
}
